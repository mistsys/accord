...
func (u *GoogleAuth) ValidateToken(ctx context.Context) (bool, string, error) {
	...
	if tokenInfo.IssuedTo != unquote(u.ClientId) {
...
func (u *GoogleAuth) Authenticate() (*oauth2.Token, error) {
	...
	if u.ClientId == defaultClientID || u.ClientSecret == defaultClientSecret {
	...
	clientId = unquote(u.ClientId)
	clientSecret = unquote(u.ClientSecret)
